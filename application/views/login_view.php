...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/LDK-login.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> Copyright &copy; Sistem Laporan Pelatihan - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
