          ...
          <div class="box box-warning">
            ...
            <div class="box-body row">
              <div class="form-group col-md-3">
                <label>Jumlah WI & Pengajar <i class="fa fa-info-circle text-blue" data-toggle="tooltip" title="Total jumlah widyaiswara dan pengajar"></i></label>
                <input type="number" name="jumlah_wi_pengajar" class="form-control" min="0" value="0">
              </div>
              <div class="form-group col-md-3">
                <label>WI S1 <i class="fa fa-info-circle text-blue" data-toggle="tooltip" title="Jumlah widyaiswara dengan pendidikan S1"></i></label>
                <input type="number" name="jumlah_pendidikan_wi_s1" class="form-control" min="0" value="0">
              </div>
              <div class="form-group col-md-3">
                <label>WI S2 <i class="fa fa-info-circle text-blue" data-toggle="tooltip" title="Jumlah widyaiswara dengan pendidikan S2"></i></label>
                <input type="number" name="jumlah_pendidikan_wi_s2" class="form-control" min="0" value="0">
              </div>
              <div class="form-group col-md-3">
                <label>WI S3 <i class="fa fa-info-circle text-blue" data-toggle="tooltip" title="Jumlah widyaiswara dengan pendidikan S3"></i></label>
